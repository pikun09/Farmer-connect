...
class _GeneralScreenState extends State<GeneralScreen>
  ...
  String formatedDate(date) {
    final outPutDateFormate =
        DateFormat('dd/MM/yyyy'); // here you can specify the format you want
    final outPutDate =
        outPutDateFormate.format(date); // this will format your date
    return outPutDate;
  }
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                validator: ((value) {
                  if (value!.isEmpty) {
                    return 'Please enter Product Dscription';
                  } else {
                    return null;
                  }
                }),
